...
<head>
    ...
    <title>Error 404 | CRMS Lead Customer Management</title>
...
<body class="error-page">
                ...
                <div class="col-md-8 d-flex align-items-center justify-content-center mx-auto">
                    <div>
                        <div class="error-img p-4">
                            <img src="{{ asset('assets/img/error-404.png') }}" class="img-fluid" alt="Img">
                        </div>
                        <div class="text-center">
                            ...
                            <div class="pb-4">
                                <a href="{{ url('/dashboard') }}" class="btn btn-primary d-inline-flex align-items-center">
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="06c25713361c54b461d7ce60-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="06c25713361c54b461d7ce60-text/javascript"></script>    

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="06c25713361c54b461d7ce60-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="06c25713361c54b461d7ce60-text/javascript"></script>

<script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="06c25713361c54b461d7ce60-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"version":"2024.11.0","token":"3ca157e612a14eccbb30cf6db6691c29","server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
</body>
